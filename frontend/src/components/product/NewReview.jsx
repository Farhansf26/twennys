...
const NewReview = ({ productReviews, productId }) => {
  ...
  const checkReviews = productReviews.find(review => review.user._id.toString() === user._id.toString())

  return (
    <div>
      {canReview && !checkReviews && (
        <button
          id="review_btn"
          type="button"
